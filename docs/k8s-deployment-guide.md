...
```
See `manifests/openclaw/agents/resource-optimizer-rbac.yaml.envsubst` for a working example.
...
| `manifests/openclaw/agents/setup-resource-optimizer-rbac.sh` | Manual RBAC setup for resource-optimizer |
